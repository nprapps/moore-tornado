...
//    mapbox.load(['npr.map-g7ewv5af','npr.ok-moore-tornado'], function(data){
    mapbox.load(['npr.map-g7ewv5af','npr.ok-moore-tornado-satellite'], function(data){
//    mapbox.load(['http://a.tiles.mapbox.com/v3/npr.map-g7ewv5af.jsonp', 'http://localhost:20009/api/Project/okla-tornadoe'], function(data){
